      ...
      >
        <div className='text-center space-y-2 text-sm'>
          ...
          <p className='text-gray-300 mb-2'>
            Tu turno fue enviado correctamente. Te enviamos un email con los detalles.
          </p>
